...
<html lang="en">
<head>
  <link rel="shortcut icon" type="image/x-icon" href="<c:url value="/image/icons/science_FILL1_wght600_GRAD0_opsz48.svg"/>"></link>
  ...
  <div class="row">
    <div class="col-4">
      <div class="list-group" id="list-lib-tab" role="tablist">
        <a class="list-group-item list-group-item-action " id="list-923-list" data-toggle="list" href="#list-923" role="tab" aria-controls="923">923创新实验室</a>
        <a class="list-group-item list-group-item-action active" id="list-925-list" data-toggle="list" href="#list-925" role="tab" aria-controls="925">925移动开发实验室</a>
      </div>
    </div>
    <div class="col-8">
      <div class="tab-content" id="nav-lib-tabContent">
        <div class="tab-pane fade " id="list-923" role="tabpanel" aria-labelledby="list-923-list">
          <p>
        ...
        <div class="tab-pane fade active show" id="list-925" role="tabpanel" aria-labelledby="list-925-list">
          <p>
