...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            <ul class="list-group">
                <a href="static/jygz.jsp" class="list-group-item">就业工作</a>
                <a href="static/jyxx.jsp" class="list-group-item active">就业信息</a>
            </ul>
        ...
        <div class="col-md-9">
            <ul class="list-group list-group-flush">
                ...
                <div class="row" style="border-bottom:1px solid darkgray; padding: 1rem;">
                    <div class="col-md-10">
                        <a href="info/example.jsp" class="list-item" style="font-size:1.3rem;">深化校企合作，共促学生发展系列宣讲①/东软集团专场</a>
                    </div>
                    <div class="col-md-2">
                        <span>2022-3-21</span>
                    </div>
                ...
                <div class="row" style="border-bottom:1px solid darkgray; padding: 1rem;">
                    <div class="col-md-10">
                        <a href="info/example.jsp" class="list-item" style="font-size:1.3rem;">2022届老板电器校园招聘公告</a>
                    </div>
                    <div class="col-md-2">
                        <span>2022-3-8</span>
                    </div>
                ...
                <div class="row" style="border-bottom:1px solid darkgray; padding: 1rem;">
                    <div class="col-md-10">
                        <a href="info/example.jsp" class="list-item" style="font-size:1.3rem;">招商银行广州分行2022春季校园招聘公告</a>
                    </div>
                    <div class="col-md-2">
                        <span>2022-3-8</span>
                    </div>
