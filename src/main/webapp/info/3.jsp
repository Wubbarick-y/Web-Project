...
<div class="container">
  <h2 align="center">张锡英</h2>
  <hr/>
  <img src="image/teachers/张锡英-副教授.jpg" alt="张锡英副教授" style="display: block; max-width: 20%;max-height: 20%; margin: auto;">

  <p style="text-indent: 2rem ;line-height:2">
    张锡英， 副教授，硕士，硕士生导师。主要研究方向：现代信息技术及网络应用，数据库技术、图像检索。主持或参加科研项目 11 项，发表论文 9 篇，出版教材 2 部。获得省级科学技术进步奖1次， 2 门课精品课主讲教师。    <br/>
    所在学科：<strong>
